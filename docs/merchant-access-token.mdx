---
title: "Overview"
description: "The Static Token in the header is required for Revolv3's REST API. This authentication mechanism ensures secure access and prevents unauthorized usage of our API."
---
