...
description: "Revolv3 allows flexible  for PaymentMethod, depending on  and . This guide outlines the , API request formats, and best practices for handling billing addresses in Revolv3."
---
