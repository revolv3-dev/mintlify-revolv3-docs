---
title: "Create a Subscription V0"
description: "Make sure you have your Merchant Configured on Portal with: Payment Processor configured and an API Key in the header Also make sure to have a ‘Recurring Strategy’ set on the portal with time and processor"
---
