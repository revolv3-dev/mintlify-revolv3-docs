...
| --- |
| The webhook is triggered when an invoice is created in the system. Notes: one-time payment invoices, recurrent payment invoices, installments payment invoices. |
